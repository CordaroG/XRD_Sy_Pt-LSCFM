This is the repository for Matlab codes used to analyze X-ray diffraction (XRD) synchrotron data collected at Soleil during the measurement week between the 6 July 2021 to the 12 July 2021.

To use these codes, place folder the desired file with the corresponding dataset, as well as the file "backcor".
